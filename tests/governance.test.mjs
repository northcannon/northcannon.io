...
test('migration preserves each baseline ID and approval state once, with a single authority', async () => {
  ...
  // 5 pending lending-only diagram claims replaced by industry-agnostic ones, and 16 systems-of-record chips trimmed in review.
  assert.equal(current.claims.filter(c => c.lifecycle_state === 'retired').length, 62);
